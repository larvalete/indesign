...
function scaleFrameAndContentProportionally(frame, targetWidth) {
    ...
    frame.transform(
        CoordinateSpaces.PASTEBOARD_COORDINATES, // Specify the coordinate space for the transformation
        AnchorPoint.CENTER_ANCHOR,               // Specify the anchor point for the transformation
        TransformSequence.createScale(scaleFactor, scaleFactor), // Create a scale transformation sequence
        undefined,                               // No specific point around which to transform
        true                                     // Whether to transform all contents of the frame
    );
}
