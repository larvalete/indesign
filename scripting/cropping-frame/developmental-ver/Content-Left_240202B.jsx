...
function cropFrameWidthFromLeftCenter(frame, targetWidth) {
    ...
    // Calculate new top and bottom positions based on target width
    var top = centerY - (targetWidth / 2);
    var bottom = centerY + (targetWidth / 2);
...
function applyTransformationsToFrame() {
    ...
    cropFrameHeight(frame, 350);           // Step 3: Crop the frame to height 350
    shrinkContentWidth(frame, 92.5);       // Step 4: Shrink the frame's content to width 92.5
}
