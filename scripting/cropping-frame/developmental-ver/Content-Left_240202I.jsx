...
function scaleFrameAndContentProportionally(frame, targetWidth) {
    ...
    frame.transform(
        ...
        [scaleFactor, scaleFactor], // Scale both horizontally and vertically
        undefined, // No need to specify the point for transformation
        true, // Scale content when the frame is scaled
        true, // Scale strokes and effects
        true  // Scale proportionally
    );
}
